...
pub enum Command {
    ...
    Scan {
        /// Directory to scan recursively (or use --inventory)
        #[arg(required_unless_present = "inventory", conflicts_with = "inventory")]
        directory: Option<PathBuf>,
        /// Scan the targets listed in an inventory file (generated by discover)
...
impl ScannerKind {
    ...
    pub fn asset_type(self) -> AssetType {
        match self {
            Self::Cert => AssetType::Cert,
            Self::Ssh => AssetType::Ssh,
            Self::Secrets => AssetType::Secret,
            Self::Jwt => AssetType::Jwt,
        }
    }
}
